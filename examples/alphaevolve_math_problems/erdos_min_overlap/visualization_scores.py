...
WITH_GCA_RUN_DIR = BASE_DIR / "runs/260307_seed42_gca_on"

# Run folder with GCA disabled (contains checkpoints/checkpoint_*/)
WITHOUT_GCA_RUN_DIR = BASE_DIR / "runs/260307_seed42_gca_off"

# Metric key from program metrics to plot
METRIC = "combined_score"

# Plot title
PLOT_TITLE = "erdos_min_overlap - GCA vs No-GCA: Score by Iteration"
