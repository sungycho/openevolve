...
WITH_GCA_RUN_DIR = BASE_DIR / "runs/260304_seed42_gca_on_v2"

# Run folder with GCA disabled (contains checkpoints/checkpoint_*/)
WITHOUT_GCA_RUN_DIR = BASE_DIR / "runs/260304_seed42_gca_off_v2"

# Metric key from program metrics to plot
METRIC = "overall_score"

# Plot title
PLOT_TITLE = "signal_processing - GCA vs No-GCA: Score by Iteration"
